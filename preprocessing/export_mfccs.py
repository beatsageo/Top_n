...
def save_mfcc(dataset_path, json_path, log_path, num_mfcc=13, n_fft=2048, hop_length=512, num_segments=5):
        ...
        if dirpath is not dataset_path:
            ...
            for f in filenames:
                ...
                try:
                    ...
                    log["failCount"] += 1
                    log["failed"].append({"file": file_path, "exception": e})
...
if __name__ == "__main__":
    save_mfcc(DATASET_PATH, JSON_PATH, LOG_PATH, num_segments=10)
